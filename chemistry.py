...
def main():
    # The periodic table is stored in a variable called periodic_table_list
    periodic_table_list = make_periodic_table()


    # For every chemical in the periodic_table_list,
    # print the chemical's symbol and the chemical's atomic mass
    for chemical in periodic_table_list:
        print(chemical[SYMBOL], chemical[ATOMIC_MASS])
        # Get a chemical formula for a molecule from the user.
    input(int("Please enter a chemical formula for a molecule"))

    # Get the mass of a chemical sample in grams from the user.
    input("Please enter the mass of a chemical in grams: ")
    ...
    symbols_and_atoms = parse_formula(formula, periodic_table_dict)
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    for chemical_key, chemical_list in periodic_table_dict:
