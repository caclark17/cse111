...
#1. Add code to the print_death_age function that 
    #prints the birth year and death year for each person.

#2. Add to your program a function named count_marriages that 
...
def print_death_age(people_dict):
    ...
    for person in people_dict.values():
        print(person[NAME_INDEX], int(person[DEATH_YEAR_INDEX]) - int(person[BIRTH_YEAR_INDEX]) )
...
def count_genders(people_dict):
    ...
    print("Genders")
    print(f'The number of females is: {female}')
...
def print_marriages(marriages_dict, people_dict):
    ...
    for marriage in marriages_dict.values():
        ...
        husband_age = marriage[WEDDING_YEAR_INDEX] - people_dict[husband_key][BIRTH_YEAR_INDEX]
        wife_age = marriage[WEDDING_YEAR_INDEX] - people_dict[wife_key][BIRTH_YEAR_INDEX]
        marriage_year = marriage[WEDDING_YEAR_INDEX]
